...
from mimicgen.configs.robosuite import Square_Config
...
def parse_source_dataset(
    ...
    for ind in range(len(demo_keys)):
        ep_grp = np.load(dataset_path, allow_pickle=True)
        ...
        for subtask_ind in range(len(subtask_term_signals)):
            ...
            if subtask_term_signal is None:
                ...
                subtask_term_ind = len(ep_grp["action_infos"])
            else:
...
class DataGenerator(object):
    ...
    def _load_dataset(self, dataset_path, demo_keys):
        ...
        self.src_dataset_infos, self.src_subtask_indices, self.subtask_names, _ = parse_source_dataset(
    ...
    def generate(
        ...
        for subtask_ind in range(len(self.task_spec)):
            ...
            if need_source_demo_selection:
                ...
                # )
                selected_src_demo_ind = 0
            assert (selected_src_demo_ind is not None)

            # selected subtask segment time indices
            selected_src_subtask_inds = all_subtask_inds[0, subtask_ind]
...
if __name__ == "__main__":
    ...
    generator = DataGenerator(task_spec=task_spec,
                              dataset_path="ep_1731256192_893864/state_1731256247_896538.npz")
    
    # print(parse_source_dataset(dataset_path="ep_1731256192_893864/state_1731256247_896538.npz",
    #                            task_spec=task_spec))
    # print(generator.randomize_subtask_boundaries())
